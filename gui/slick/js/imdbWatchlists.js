...
//    		last_input = key_value_groups.last();
    	...
    	function addWatchlistInput(enabled, url) {
    		...
    		*/
    		...
    		parent.append('<div id="kv-' + next_id + '" class="key-value-group clearfix"> <input type="checkbox" class="enabler" id="imdb_wl_ids_enabled-' + next_id + '" '+ enabled +' size="100" /><input type="text" id="imdb_wl_ids-' + next_id + '" value="' + url + '" size="40" /></div>')
    		regHandlers();
    	}
